    ...
    <div class="person clearfix">
        <div class="order_l person_l">
            <ul id="left_menu" class="left_menu">
                <li>
                    <a class="yiji" href="#aboutus" data-toggle="tab"><span>关于我们</span></a>
                </li>
                <li>
                    <a class="yiji" href="#contactus" data-toggle="tab"><span>联系我们</span></a>
                </li>
                <li>
                    ...
                    <ul class="erji">
                        <li>
                            <i>&nbsp;</i>
                            <strong><a href="#howregister" data-toggle="tab">如何注册</a></strong>
                        </li>
                ...
                <li>
                    <a class="yiji" href="#cjwt" data-toggle="tab"><span>常见问题</span><em>&nbsp;</em></a>
                    <ul class="erji">
                        <li>
                            <i>&nbsp;</i>
                ...
                <li>
                    <a class="yiji" href="#jianyi" data-toggle="tab"><span>咨询/建议/投诉</span></a>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-pane" id="contactus">
            <div class="person_r">
                ...
                <div class="person_rmain">
                    ...
                    <div class="content">
                        <p>
                            招聘邮箱：<a href="">hr@wuhe.com</a>
                            公司名称:舞鹤信息物流有限公司<br>
                            总部电话:027-88110263(总机) 13517221678<br>
                            传真电话:027-88128379<br>
                            招商电话:027-88124640 88127640<br>
                            免费信息发布:8008800268<br>
                            信息查询专线:027-88128379<br>
                            公司网址:www.wuhelogis.com<br>
                            公司邮箱:zn56@zn56.com ceo@zn56.com<br>
                            信息发布联系:舞鹤物流有限公司信息中心<br>
                        </p>
